                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('order.store') }}" method="POST">@csrf
                      <div class="form-group ">
                          ...
                          <p><input type="date" name="date" class="from-control" required></p>
                          <p><input type="time" name="time" class="from-control" required></p>
                          <p><textarea class="from-control" name="body" required></textarea></p>
                          <p class="text-center">
                              <button class="btn btn-danger" type="submit">Meke order</button>
                          </p>
                          @if (session('message'))
